    ...
    <div style={scaleStyle} className={className}>
      ...
      >
        ...
        >
          ...
          ></div>
          <div
            className={`flex justify-center items-center absolute z-30 w-full h-full origin-bottom transition-all duration-300 ease-in-out ${!open ? "group-hover:[transform:skew(-15deg)_scaleY(0.6)]" : ""
              }`}
            style={{
              backgroundColor: color,
              borderRadius: "5px 10px 10px 10px",
          ...
          >
            <div className="text-white text-center font-semibold animate-pulse">Click me</div>
          </div>
        </div>
      </div>
    </div>
